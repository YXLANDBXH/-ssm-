		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="${ctx}/updateDocument.action" enctype="multipart/form-data" method="post">
                        <!-- 隐藏表单，flag表示添加标记 -->
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
				  		<tr><td>${message }</td></tr>
                        <input type="hidden" name="id" value="${document.id }">
					    <tr><td class="font3 fftd">
					                文档标题：<input type="text" name="title" size="30" value="${document.title }" id="title"/></td>
					    </tr>
