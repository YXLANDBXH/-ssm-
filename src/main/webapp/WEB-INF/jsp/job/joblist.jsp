	...
	$(function(){
	   ...
	   $("#checkAll").click(function(){
 	   ...
 	   $("#query").click(function(){
 		  	$("#jobform").attr("action", "${ctx}/joblistlike.action");
 		 	$("#jobform").submit();
 	   })
						...
						<tr>
							<td class="fftd">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">
											职位名：<input type="text" name="name" value="${job.jname}" />
					...
					<table width="100%" border="1" cellpadding="5" cellspacing="0"
						...
						<c:forEach items="${pageModel.list}" var="job"
							...
							<tr id="data_${stat.index}" align="center" class="main_trbg">
								<td>
									<input type="checkbox" id="box_${stat.index}" value="${job.id}" name="ids" />
								</td>
								<td>${job.jname }</td>
								<td>${job.jremark}</td>
								<td align="center" width="40px;">
									<a href="${ctx}/viewJob.action?id=${job.id}">
