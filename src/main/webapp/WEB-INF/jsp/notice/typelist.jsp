	...
	$(function(){
	   ...
	   $("#checkAll").click(function(){
 	   ...
 	   $("#query").click(function(){
 		  	$("#typeform").attr("action", "${ctx}/typelistlike.action");
 		 	$("#typeform").submit();
 	   })
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
						...
						<tr>
							<td class="fftd">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td class="font3">类型：<input type="text" name="name" value="${type.name}" />
											<input type="button" value="查询" id="query" /><input type="button" value="删除" id="delete" />
			...
			<tr valign="top">
				<td height="20">
					<table width="100%" border="1" cellpadding="5" cellspacing="0" style="border: #c2c6cc 1px solid; border-collapse: collapse;">
						...
						<c:forEach items="${pageModel.list}" var="t" varStatus="stat">
							<tr id="data_${stat.index}" align="center" class="main_trbg">
								<td><input type="checkbox" id="box_${stat.index}" value="${t.id}" name="ids" /></td>
								<td>${t.name }</td>
								<td><f:formatDate value="${t.createDate}" type="date" dateStyle="long" /></td>
								<td align="center" width="40px;">
									<a href="${ctx}/viewType.action?id=${t.id}">
